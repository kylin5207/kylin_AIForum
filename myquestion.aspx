<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="myquestion.aspx.cs" Inherits="myquestion" %>
             ...
             <ItemTemplate>
               ...
               <span class="publishdate">
                ...
                <div class="answer">
                    ...
                    <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("Expr2") %>' width="60" Height="60" AlternateText="当前暂无用户回答" CssClass="datalist-img" /><br />
                    <span style="display:inline-block;width:100px ;text-align:center;color:#1b57d1;font-weight:bold;"><asp:Label ID="userNameLabel" runat="server" Text='<%# Eval("Expr1") %>' /></span>
                    </div>
